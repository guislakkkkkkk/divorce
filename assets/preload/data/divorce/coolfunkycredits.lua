...
function onCreatePost() -- This creates all the placeholder shit B) ((THIS PART OF THE SCRIPT WAS MADE BY PIGGY))
    ...
    makeLuaText('creditTitle', 'PlaceholderTitle', objWidth, offsetX - objWidth, offsetY+35)
    setTextSize('creditTitle', 45)
    setTextAlignment('creditTitle', 'left')
    setObjectCamera('creditTitle', 'other')
    addLuaText("creditTitle",true)

    makeLuaText('creditCreator', 'PlaceholderCreator', objWidth, offsetX - objWidth, offsetY+95)
    setTextSize('creditCreator', 30)
    setTextAlignment('creditCreator', 'left')
    setObjectCamera('creditCreator', 'other')

    makeLuaSprite('creditIcon', 'credits/fearless', getProperty('creditCreator.x') + 355, getProperty('creditCreator.y') - 50)
    setObjectCamera('creditIcon', 'other')
...
function onSongStart()
 ...
 if songExists == true then
    ...
    setTextString('creditCreator', "Composed by: "..curSongTable[2])
    ...
    doTweenX("creditIconTween", "creditIcon", getProperty("creditIcon.x") + objWidth, 1, "expoOut")
...
function onTimerCompleted(timerName)
    ...
    if timerName == "creditDisplay" then
        ...
        doTweenX("creditIconTween", "creditIcon", getProperty("creditIcon.x") - objWidth, 0.5, "sineIn")
